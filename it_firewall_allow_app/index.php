    ...
    <script>
        function showPopup(action, id = null) {
            ...
            if (action === 'add') {
                ...
                form.sd_wan_rules_id.value = row.dataset.sd_wan_rules_id;
                form.vpn.value = row.dataset.vpn;
                form.remarks.value = row.dataset.remarks;
...
<body>
        ...
        <tbody>
            <?php foreach ($results as $row): ?>
                <tr id="row-<?= $row['id'] ?>"
                    ...
                    data-sd_wan_rules_id="<?= htmlspecialchars($row['sd_wan_rules_id']) ?>"
                    data-vpn="<?= htmlspecialchars($row['vpn']) ?>"
                ...
                >
                    ...
                    <td><?= htmlspecialchars($row['sd_wan_rules_id']) ?></td>
                    <td><?= htmlspecialchars($row['vpn']) ?></td>
    ...
    <div id="popup" style="display:none; position:fixed; top:20%; left:30%; background:white; border:1px solid #ccc; padding:20px;">
        ...
        <form id="popupForm" method="POST">
            ...
            <label>SD WAN Rules ID: <input type="text" name="sd_wan_rules_id"></label><br>
            <label>VPN: <input type="text" name="vpn"></label><br>
